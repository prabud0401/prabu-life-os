...
- [ ] **1.1** Scaffold npm workspaces: `packages/shared`, `core`, `mcp`
- [ ] **1.2** Copy/adapt `blueocean_mcp/shared` auth + Graph client
- [ ] **1.3** Port Outlook tools (list, search, get, folders)
